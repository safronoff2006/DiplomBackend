...
private val SCALE_DATA_PATTERN_PROTOCOL1: String = "(v|V)("+
  "\\+|\\-|\\?){4}(\\?{6}|\\s{6}|\\s{5}[0-9]{1}|\\s{4}-[0-9]{1}|\\s{4}[0-9]{2}|"+
  "\\s{3}-[0-9]{2}|\\s{3}[0-9]{3}|\\s{2}-[0-9]{3}|\\s{2}[0-9]{4}|\\s{1}-[0-9]{4}|"+
  "\\s{1}[0-9]{5}|\\-[0-9]{5}|[0-9]{6})" +
  "([0-9,]{12})?"

  private val SCALE_DATA_PATTERN_PROTOCOL1_EMMARIN: String = "(v|V)("+
    "\\+|\\-|\\?){4}(\\?{6}|\\s{6}|\\s{5}[0-9]{1}|\\s{4}-[0-9]{1}|\\s{4}[0-9]{2}|"+
    "\\s{3}-[0-9]{2}|\\s{3}[0-9]{3}|\\s{2}-[0-9]{3}|\\s{2}[0-9]{4}|\\s{1}-[0-9]{4}|"+
    "\\s{1}[0-9]{5}|\\-[0-9]{5}|[0-9]{6})" +
    "([0-9,]{12})"
  ...
  private val SCALE_DATA_PATTERN_PROTOCOL2: String = "(v|V)("+
    "\\+|\\-|\\?){4}(\\?{6}|\\s{6}|\\s{5}[0-9]{1}|\\s{4}-[0-9]{1}|\\s{4}[0-9]{2}|"+
    "\\s{3}-[0-9]{2}|\\s{3}[0-9]{3}|\\s{2}-[0-9]{3}|\\s{2}[0-9]{4}|\\s{1}-[0-9]{4}"+
    "|\\s{1}[0-9]{5}|\\-[0-9]{5}|[0-9]{6})" +
  ...
  private val SCALE_DATA_PATTERN_PROTOCOL2_MIFARE: String = "(v|V)"+
    "(\\+|\\-|\\?){4}(\\?{6}|\\s{6}|\\s{5}[0-9]{1}|\\s{4}-[0-9]{1}|\\s{4}[0-9]{2}|"+
    "\\s{3}-[0-9]{2}|\\s{3}[0-9]{3}|\\s{2}-[0-9]{3}|\\s{2}[0-9]{4}|\\s{1}-[0-9]{4}|"+
    "\\s{1}[0-9]{5}|\\-[0-9]{5}|[0-9]{6})" +
